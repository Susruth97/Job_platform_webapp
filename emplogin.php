...
<h1 style=> EMPLOYE LOGIN </h1></td>
<form action="emploginaction.php" method="POST">
 <tr> 
...
?>
<tr><td align="left"  style="padding:12px 8px"><input type="submit" value="LOGIN" onclick="myFunction()"> <input type="submit" value="NEW EMPLOYER"></td></tr>
</form>
</table>
</body>
</html>